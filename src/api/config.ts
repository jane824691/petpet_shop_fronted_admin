...
export const LOGIN = API_SERVER + '/login' // method: POST, 登入
export const LOGOUT = API_SERVER + '/logout' // method: POST, 登出
export const AUTH_CHECK = API_SERVER + '/auth/check' // method: GET, 驗證登入

export const PRODUCTS = API_SERVER + '/product/api/all' // method: GET, 商品總列表
...
export const PRODUCTS_EDIT = API_SERVER + '/product/edit' // method: POST, 編輯商品
export const PRODUCTS_DELETE = API_SERVER + '/product/delete' // method: DELETE, 刪除商品
